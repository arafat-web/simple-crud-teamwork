            ...
            <ul class="navbar-nav sidenav">
                <li class="nav-link bordered px-3">
                    <a href="{{route('dashboard')}}"
                        class="nav-link px-3  @if(isset($page) && $page == 'dashboard')active @endif">
                ...
                <li class="nav-link bordered px-3">
                    ...
                    <div class="collapse @if(isset($sub_page) && $sub_page == 'students')show @endif"
                        id="collapseExample">
                        <div>
                            <ul class="navbar-nav ps-3">
                                <li>
                                    <a href="{{route('add.student')}}"
                                        class="nav-link @if(isset($page) && $page == 'add.student')active @endif px-3">
                                ...
                                <li>
                                    <a href="{{route('all.students')}}"
                                        class="nav-link @if(isset($page) && $page == 'all.students')active @endif px-3">
                ...
                <li class="nav-link bordered px-3">
                    <a href="{{route('department')}}"
                        class="nav-link  @if(isset($page) && $page == 'department')active @endif px-3">
                ...
                <li class="nav-link bordered px-3">
                    <a href="{{route('program')}}"
                        class="nav-link  @if(isset($page) && $page == 'program')active @endif px-3">
                ...
                <li class="nav-link bordered px-3">
                    <a href="{{route('profile')}}"
                        class="nav-link  @if(isset($page) && $page == 'profile')active @endif px-3">
